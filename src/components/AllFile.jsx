                ...
                <div className="allFileMiddlePart">
                        ...
                        <div className="titleLeftP">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                                    ...
                                    <li><a class="dropdown-item" href="#">Document Files</a></li>
                                    <li><a class="dropdown-item" href="#">Private Files</a></li>
                                </ul>
                            </div>
                    ...
                    <div className="fileCards my-4">
                        <div className="row">
                            ...
                            <div className="col-md-4">
                                <div className="mainCards">
                                    <NavLink className="fileCard" to="/music">
                                        <FileCard fname="Music" fNum="908" />
                                    </NavLink>
                                </div>
                            </div>
                            <div className="col-md-4">
                        ...
                        <div className="row mt-lg-4">
                            <div className="col-md-4">
                                <div className="mainCards">
                                    <NavLink className="fileCard" to="#">
                                        <FileCard fname="Personal Media" fNum="4680" />
                                    </NavLink>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="mainCards">
                                    <NavLink className="fileCard" to="#">
                                        <FileCard fname="Reddingo Backup" fNum="19" />
                                    </NavLink>
                    ...
                    <div className="allFileMainTitle">
                        <div className="titleLeftP">
                            ...
                            <span className="sp2 ms-3">All Files</span>
                        </div>
                        <div className="titleRighr">
