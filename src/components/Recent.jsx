/**ekhane ekta state nisi jetar value ekta empty array. then prottekta RecentCard er div e ekta kore 
 * onClick event nisi. jetae ekta function likhsi jeta setPre die oi card er value guli set kortese preview state e.
 * onClick={()=>setPre({icon:'iconClass',title:'title',size:'fileSize',details:'details'})}
 * then ei state ke  map korsi 'allFileRightSidePart' class er vitore. (array mapping shomporke dharona ase asha kori).
 */
            ...
            <div className="allVideosMiddlePart">
                ...
                <div className="allFileMainTitle">
                    <div className="titleLeftP">
                        ...
                        <span className="sp2 ms-3">Recent Files</span>
                    </div>
                ...
                <div className="videosMainThumbnails py-4">
                    ...
                    <div className="row pt-md-4">
                        <div className="col-md-3 sCard" onClick={()=>setPre([{icon:"fas fa-file-excel",title:"Marketinf Strategy on Waterfall INC.xls",size:"1.6MB",details:"this is file 5"}])}>
                            <RecentCard recentIco={<i class="fas fa-file-excel"></i>} vdoTitle="Marketinf Strategy on
                                Waterfall INC.xls" fSize="1.6MB" />
                        </div>
                        <div className="col-md-3 sCard" onClick={()=>setPre([{icon:"fas fa-file-invoice-dollar",title:"Drone Test Drive Tour.sketch",size:"18.6MB",details:"this is file 6"}])}>
                            <RecentCard recentIco={<i class="fas fa-file-invoice-dollar"></i>} vdoTitle="Drone Test
                                Drive Tour.sketch" fSize="18.6MB" />
                        </div>
                        <div className="col-md-3 sCard" onClick={()=>setPre([{icon:"fas fa-file-video",title:"Drone Virtual Tour Scope.mp4",size:"446.3",details:"this is file 7"}])}>
                            <RecentCard recentIco={<i class="fas fa-file-video"></i>} vdoTitle="Drone Virtual Tour
                                Scope.mp4" fSize="446.3" />
                        </div>
                        <div className="col-md-3 sCard" onClick={()=>setPre([{icon:"fas fa-file-word",title:"Waterfall INC Introduction.word",size:"5.7MB",details:"this is file 8"}])}>
                            <RecentCard recentIco={<i class="fas fa-file-word"></i>} vdoTitle="Waterfall INC
                                Introduction.word" fSize="5.7MB" />
                        </div>
                    </div>
                    <div className="row pt-md-4">
                        <div className="col-md-3 sCard" onClick={()=>setPre([{icon:"fas fa-file-invoice-dollar",title:"Drone Test Drive Tour.sketch",size:"18.6MB",details:"this is file 9"}])}>
                            <RecentCard recentIco={<i class="fas fa-file-invoice-dollar"></i>} vdoTitle="Drone Test
                                Drive Tour.sketch" fSize="18.6MB" />
                        </div>
                        <div className="col-md-3 sCard" onClick={()=>setPre([{icon:"fas fa-file-pdf",title:"Licence Agreement on Waterfall INC.pdf",size:"2.3MB",details:"this is file 10"}])}>
                            <RecentCard recentIco={<i class="fas fa-file-pdf"></i>} vdoTitle="Licence Agreement on
                                Waterfall INC.pdf" fSize="2.3MB" />
                        </div>
                        <div className="col-md-3 sCard" onClick={()=>setPre([{icon:"fas fa-file-word",title:"Waterfall INC Introduction.word",size:"5.7MB",details:"this is file 11"}])}>
                            <RecentCard recentIco={<i class="fas fa-file-word"></i>} vdoTitle="Waterfall INC
                                Introduction.word" fSize="5.7MB" />
                        </div>
                        <div className="col-md-3 sCard" onClick={()=>setPre([{icon:"fas fa-file-video",title:"Drone Virtual Tour Scope.mp4",size:"446.3",details:"this is file 12"}])}>
                            <RecentCard recentIco={<i class="fas fa-file-video"></i>} vdoTitle="Drone Virtual Tour
                                Scope.mp4" fSize="446.3" />
                        </div>
                    </div>
