                ...
                <div className="allVideosMiddlePart">
                    ...
                    <div className="allFileMainTitle">
                        <div className="titleLeftP">
                            ...
                            <i class='bx bxs-chevron-right'></i>
                            <span className="sp2">Work Project</span>
          ...
          {preview.length>0?<div class="allFileRightSidePart py-5">{
            ...
            preview.map(rec=>
                <div class="allPreviewPart">
                    ...
                    <hr class="my-5" />
                    <div class="shareFieldIcons">
                        <div class="field1"><a href="#"><i class="bx bx-share bx-flip-horizontal"></i></a>
                            <p>Share</p>
                        </div>
                        <div class="field1"><a href="#"><i class="bx bx-pencil bx-flip-horizontal"></i></a>
                            <p>Edit</p>
                        </div>
                        <div class="field1"><a href="#"><i class="bx bx-trash-alt"></i></a>
                            <p>Delete</p>
                        </div>
                    </div>
                    <hr class="my-4" />
